    ...
    <div className="w-auto h-[90vh] border-r">
      <div className="flex flex-col h-24 gap-2 p-2 border-b mt-[1px]">
        <button
          ...
          className="flex flex-row items-center w-full h-12 px-2 text-xs text-gray-500 rounded md:text-sm font-roboto hover:bg-gray-200 focus:bg-blue-100 focus:text-blue-500"
        >
